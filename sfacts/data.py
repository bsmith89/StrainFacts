...
class World:
    ...
    def keep_only_strain_list(self, strain_list, agg_strain_coord=-1):
        is_in_strain_list = self.strain.to_series().isin(strain_list)
        relabel = self.strain.to_series().where(is_in_strain_list, agg_strain_coord)
